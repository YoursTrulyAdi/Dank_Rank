...
import { collection, getDocs, doc, updateDoc, increment, setDoc, addDoc, getDoc } from "firebase/firestore";
...
function UserDashboard() {
    ...
    return (
        <div>
            ...
            <main className="bg-[#2d2b55] text-white p-6 flex flex-col lg:flex-row gap-6 lg:gap-10">
                {/* Profile */}
                <div className="flex flex-col w-full lg:w-[30%] bg-[#191830] rounded-xl shadow-md p-6 items-center">
                    {user && (
                        <>
                            <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-[#f75990] shadow-lg">
                                <img
